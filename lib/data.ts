...
export const mockMessages: SupportMessage[] = [
  ...
  },
  {
    ...
    message: 'The app keeps crashing when I try to upload a large PDF file. This is urgent!',
  ...
  },
  {
    ...
    message: 'Can you add support for dark mode in the next release? Would love to have this feature.',
  ...
  },
  {
    ...
    message: 'I need help with my account settings. Not sure how to update my profile picture.',
  ...
  },
  {
    ...
    message: 'Payment failed but money was deducted from my account. Please check ASAP.',
  ...
  },
  {
    ...
    message: 'Export function is not working. Getting "server error" message every time.',
  ...
  },
  {
    ...
    message: 'Would be great if we could schedule reports to be sent automatically.',
